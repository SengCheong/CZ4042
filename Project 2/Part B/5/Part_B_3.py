...
def main():
  ...
  with tf.Session() as sess:
    ...
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b3_training_cost.txt',np_training_costs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b3_test_accs.txt',np_test_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b3_training_acc.txt',np_training_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b3_time.txt',np_times)
