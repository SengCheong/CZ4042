...
def rnn_model(x):
  ...
  cells = tf.nn.rnn_cell.MultiRNNCell([cell,cell])
  _, encoding = tf.nn.static_rnn(cells, char_list, dtype=tf.float32)
...
def main():
  ...
  with tf.Session() as sess:
    ...
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/char_L2_training_cost.txt',np_training_costs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/char_L2_test_accs.txt',np_test_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/char_L2_training_acc.txt',np_training_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/char_L2_time.txt',np_times)
