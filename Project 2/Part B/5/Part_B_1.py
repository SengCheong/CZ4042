...
def configure_char_cnn_model(x):
...
def main():
  ...
  logits = configure_char_cnn_model(x)
  ...
  with tf.Session() as sess:
    ...
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b1_training_cost.txt',np_training_costs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b1_test_accs.txt',np_test_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b1_training_acc.txt',np_training_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b1_time.txt',np_times)
