...
def main():
    ...
    try:
        prev_data_test_accs = np.loadtxt('/content/gdrive/My Drive/Colab Notebooks/standard_test_accs.txt',ndmin=2)
        np_test_accs = np.append(prev_data_test_accs,np_test_accs,axis=0)

        prev_data_training_cost = np.loadtxt('/content/gdrive/My Drive/Colab Notebooks/standard_training_cost.txt',ndmin=2)
        np_training_costs = np.append(prev_data_training_cost,np_training_costs,axis=0)

        np.savetxt('/content/gdrive/My Drive/Colab Notebooks/standard_training_cost.txt',np_training_costs)
        np.savetxt('/content/gdrive/My Drive/Colab Notebooks/standard_test_accs.txt',np_test_accs)
