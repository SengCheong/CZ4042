...
final_test_acc_pts = [standard_test_accs,momentum_test_accs,rmsprop_test_accs,adam_test_accs]

for dropout in dropouts_test_accs:
	final_test_acc_pts.append(dropout)

final_training_cost_pts = [standard_training_cost,momentum_training_cost,rmsprop_training_cost,adam_training_cost]
