...
def main():
    ...
    try:
        ...
        np.savetxt('/content/gdrive/My Drive/Colab Notebooks/rmsprop_training_cost.txt',np_training_costs)
        np.savetxt('/content/gdrive/My Drive/Colab Notebooks/rmsprop_test_accs.txt',np_test_accs)
