...
def rnn_model(x):
  ...
  _, encoding2 = tf.nn.static_rnn(cell2, encoding1, dtype=tf.float32)

  logits = tf.layers.dense(encoding1, MAX_LABEL, activation=None)
...
def main():
  ...
  with tf.Session() as sess:
    ...
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b4_training_cost.txt',np_training_costs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b4_test_accs.txt',np_test_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b4_training_acc.txt',np_training_accs)
    np.savetxt('/content/gdrive/My Drive/Colab Notebooks/b4_time.txt',np_times)
